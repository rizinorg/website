...
After that, I added support for platform profiles. Platform profiles were introduced to handle the platform specific differences. These files
...
I would like to thank my mentors [xvilka](https://github.com/xvilka) and [deroad](https://github.com/wargio) for their guidance.
