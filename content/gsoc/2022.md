...
that is based on the BAP's Core Theory was implemented. In the following months it was improved
and some of the architectures were ported to use RZIL instead of ESIL. The main goal of this project
is to finish the migration of the existing architectures that still use ESIL or add a RZIL support
